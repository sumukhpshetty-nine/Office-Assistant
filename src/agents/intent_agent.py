...
Important:
- Consider the previous conversation when understanding follow-up questions.
- If the user says "them", "it", "that", etc., use the conversation history to understand what they refer to.
